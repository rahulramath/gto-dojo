...
export const LINES: LineDef[] = [
  {
    ...
    potBB: 5.5,
    stackBB: 97.5,
    preflop: "The button opens to 2.5bb and the big blind calls.",
    pfrRange: () => raiseW(CHARTS.rfi_BTN),
    callerRange: () => callW(CHARTS.vo_BB_BTN),
  },
  {
    id: "CO_BB",
    label: "Cutoff vs big blind",
    potType: "SRP",
    pfr: "CO",
    caller: "BB",
    pfrIP: true,
    potBB: 5.5,
    stackBB: 97.5,
    preflop: "The cutoff opens to 2.5bb and the big blind calls.",
    pfrRange: () => raiseW(CHARTS.rfi_CO),
    callerRange: () => callW(CHARTS.vo_BB_CO),
  },
  {
    id: "LJ_BB",
    label: "UTG vs big blind",
    potType: "SRP",
    pfr: "LJ",
    caller: "BB",
    pfrIP: true,
    potBB: 5.5,
    stackBB: 97.5,
    preflop: "UTG opens to 2.5bb and the big blind calls.",
    pfrRange: () => raiseW(CHARTS.rfi_LJ),
    callerRange: () => callW(CHARTS.vo_BB_LJ),
  },
  {
    id: "CO_BTN",
    label: "Cutoff vs button",
    potType: "SRP",
    pfr: "CO",
    caller: "BTN",
    pfrIP: false,
    potBB: 6.5,
    stackBB: 97.5,
    preflop: "The cutoff opens to 2.5bb, the button calls and the blinds fold.",
    pfrRange: () => raiseW(CHARTS.rfi_CO),
    callerRange: () => callW(CHARTS.vo_BTN_CO),
  },
  {
    id: "SB_BB",
    label: "Small blind vs big blind",
    potType: "SRP",
    pfr: "SB",
    caller: "BB",
    pfrIP: false,
    potBB: 6,
    stackBB: 97,
    preflop: "It folds to the small blind, who raises to 3bb. The big blind calls.",
    pfrRange: () => raiseW(CHARTS.rfi_SB),
    callerRange: () => callW(CHARTS.vo_BB_SB),
  },
  {
    id: "BTN_BB_3B",
    label: "Big blind 3-bets the button",
    potType: "3BP",
    pfr: "BB",
    caller: "BTN",
    pfrIP: false,
    potBB: 22.5,
    stackBB: 89,
    preflop: "The button opens to 2.5bb, the big blind 3-bets to 11bb and the button calls.",
    pfrRange: () => raiseW(CHARTS.vo_BB_BTN),
    callerRange: () => callW(CHARTS.v3_BTN_IP),
  },
  {
    id: "CO_BTN_3B",
    label: "Button 3-bets the cutoff",
    potType: "3BP",
    pfr: "BTN",
    caller: "CO",
    pfrIP: true,
    potBB: 16.5,
    stackBB: 92.5,
    preflop: "The cutoff opens to 2.5bb, the button 3-bets to 7.5bb and the cutoff calls.",
...
export const FAMILY_INFO: Record<Family, { name: string; summary: string }> = {
  RANGE_SMALL: {
    name: "Bet small with almost everything",
    summary: "This dry board is great for your range. A small bet with nearly every hand is cheap, gets called by worse and keeps their draws from seeing free cards.",
  },
  POLAR_BIG: {
    name: "Bet big or check",
    summary: "You have more of the best hands on a board that changes a lot. Bet big with strong hands and good draws, and check your medium hands.",
  },
  MIXED: {
    name: "Mix your bet sizes",
    summary: "You have a small edge here. Bet small with thin value and backdoor draws, bet big with strong hands and big draws, and check a lot of medium hands.",
  },
  CHECK_HEAVY: {
    name: "Check most hands",
    summary: "This board is better for their range. Check most of your hands and only bet your strong hands and strong draws.",
  },
  CALLER_LEAD: {
    name: "Check to the raiser",
    summary: "You called preflop and you act first, so you usually check and let the raiser bet.",
  },
  STAB: {
    name: "Bet when they check",
    summary: "Their check usually means they don't have much. Bet often, since a lot of their hands fold to one bet.",
  },
  BARREL_HIGH: {
    name: "Keep betting",
    summary: "This turn card is good for your range. Keep betting big with your value hands and your best draws.",
  },
  BARREL_MID: {
    name: "Pick your spots",
    summary: "This turn doesn't change much. Keep betting strong hands and good draws, and give up with most of your air.",
  },
  BARREL_LOW: {
    name: "Slow down",
    summary: "This turn helps their range. Check most hands and only keep betting the nuts and big draws.",
  },
  PROBE: {
    name: "Lead out",
    summary: "They checked back last street, so their range is weaker. Bet your value hands and some bluffs.",
  },
  RIVER_POLAR: {
    name: "Bet big hands and some bluffs",
    summary: "On the river, bet your strong hands plus the right number of bluffs. Check the medium hands that can win at showdown.",
  },
  RIVER_LEAD: {
    name: "Mostly check",
    summary: "You act first and they have the lead, so you mostly check and only bet some of your strong hands.",
  },
};
