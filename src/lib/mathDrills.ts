import { cardsPretty, parseCards, type Card } from "./cards";
import { handVsHand } from "./equity";
...
export type DrillId = "potodds" | "mdf" | "outs" | "combos" | "equity" | "ev";
...
export const GEN: Record<DrillId, (r: () => number) => Q> = { potodds: genPotOdds, mdf: genMdf, outs: genOuts, combos: genCombos, equity: genEquity, ev: genEv };
